...
As previsões feitas por h2 permitiram reduzir bem o valor do MSE da regressão, tornando-a mais eficiente que h1. Percebe-se também que a retirada da garagem, na estruturação da regressão 3 (h3), alterou pouco o MSE3, confirmando a análise da anova que ele mostrou sua baixa contribuição para a análise (os outros dois fatores são mais relevantes).
